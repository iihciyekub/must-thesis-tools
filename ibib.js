...
const strokes = [
    "乙", "丁", "九", "刁", "刀", "力", "乜", "于", "士", "才", "寸", "大", "上", "山", "千", "及", "夕", "之", "己", "弓", "子", "王", "亓", "井", "天", "夫", "元", "五", "支", "不", "太", "友", "尤", "巨", "戈", "止", "少", "中", "水", "牛", "毛", "壬", "仁", "仇", "仉", "化", "仍", "戶", "户", "介", "公", "丹", "勾", "殳", "卞", "六", "文", "亢", "方", "尹", "孔", "巴", "以", "允", "毋", "玉", "示", "邗", "巧", "邛", "功", "甘", "世", "艾", "古", "本", "可", "丙", "左", "石", "布", "戊", "平", "北", "占", "甲", "申", "田", "由", "史", "冉", "生", "禾", "丘", "代", "仙", "白", "他", "瓜", "仝", "令", "用", "印", "卯", "包", "市", "玄", "永", "司", "弘", "出", "召", "皮", "台", "母", "匡", "刑", "邢", "戎", "圭", "吉", "考", "老", "芒", "西", "在", "有", "百", "成", "夷", "光", "曲", "同", "回", "年", "朱", "竹", "休", "伍", "伏", "延", "仲", "仵", "任", "仰", "伊", "向", "似", "行", "全", "合", "兆", "夙", "危", "多", "次", "衣", "亥", "充", "羊", "米", "汗", "江", "汲", "池", "汝", "宇", "守", "字", "安", "祁", "那", "阮", "羽", "牟", "扶", "抄", "赤", "折", "孝", "抗", "却", "芮", "花", "杜", "巫", "杞", "李", "求", "孛", "車", "车", "甫", "束", "吾", "豆", "邴", "夾", "夹", "邶", "步", "肖", "貝", "贝", "呂", "吕", "別", "别", "吳", "吴", "岑", "告", "利", "邱", "何", "但", "伯", "佟", "位", "佛", "佘", "希", "邸", "狂", "狄", "彤", "系", "言", "况", "冷", "辛", "汪", "沐", "沙", "沃", "沈", "忻", "完", "宋", "宏", "牢", "良", "初", "罕", "尾", "局", "改", "阿", "陀", "姒", "邵", "邰", "奉", "武", "青", "表", "長", "长", "拓", "幸", "招", "其", "苦", "昔", "茂", "苗", "英", "苟", "茆", "苑", "茅", "林", "枝", "枚", "析", "板", "來", "来", "松", "杭", "東", "东", "奈", "奇", "叔", "歧", "卓", "虎", "尚", "果", "昌", "門", "门", "明", "易", "昂", "典", "呼", "帖", "迮", "牧", "和", "季", "委", "竺", "侍", "岳", "佴", "佼", "依", "帛", "卑", "所", "金", "受", "念", "瓮", "朋", "肥", "周", "咎", "京", "冼", "府", "庚", "於", "卷", "法", "泣", "泥", "波", "性", "宗", "定", "宜", "官", "空", "宛", "宓", "郎", "房", "祈", "建", "居", "屈", "承", "孟", "函", "姓", "始", "春", "封", "拱", "城", "郝", "荊", "荆", "革", "荀", "胡", "茹", "南", "柯", "查", "相", "柏", "柳", "厙", "厍", "威", "厚", "郟", "郏", "是", "冒", "星", "哈", "拜", "郜", "香", "秋", "段", "修", "保", "信", "皇", "泉", "禹", "侯", "帥", "帅", "俟", "律", "後", "后", "俞", "郗", "俎", "風", "风", "逄", "昝", "計", "计", "哀", "度", "奕", "施", "前", "首", "洪", "洛", "洋", "宣", "宦", "冠", "軍", "军", "祖", "祝", "弭", "韋", "韦", "胥", "姚", "飛", "飞", "盈", "羿", "勇", "柔", "紅", "红", "紀", "纪", "泰", "秦", "班", "敖", "素", "馬", "马", "貢", "贡", "袁", "都", "盍", "耿", "華", "华", "恭", "莫", "仓", "倉", "莘", "晋", "真", "莊", "庄", "桂", "桓", "桐", "校", "索", "軒", "轩", "連", "连", "速", "栗", "夏", "原", "柴", "時", "时", "畢", "毕", "閃", "闪", "晁", "晏", "員", "员", "剛", "刚", "乘", "秘", "候", "倪", "倫", "伦", "隽", "皋", "烏", "乌", "師", "师", "徐", "殷", "針", "针", "釗", "钊", "奚", "翁", "卿", "逢", "留", "衷", "高", "郭", "席", "庫", "库", "唐", "旁", "旅", "益", "烟", "郯", "浦", "酒", "海", "浮", "悟", "家", "宮", "宫", "容", "宰", "書", "书", "展", "陸", "陆", "陳", "陈", "孫", "孙", "陰", "阴", "陶", "姬", "通", "能", "務", "务", "桑", "納", "纳", "理", "堵", "捷", "焉", "赧", "接", "聊", "萇", "苌", "萊", "莱", "菅", "乾", "梅", "麥", "麦", "曹", "區", "区", "堅", "坚", "戚", "盛", "雪", "雀", "堂", "常", "眭", "野", "閆", "闫", "閉", "闭", "問", "问", "婁", "娄", "鄂", "國", "国", "崔", "崇", "過", "过", "犁", "笪", "符", "第", "敏", "偶", "進", "进", "偉", "伟", "從", "从", "悉", "脫", "脱", "魚", "鱼", "象", "斛", "祭", "訥", "讷", "許", "许", "庹", "麻", "庾", "康", "鹿", "章", "商", "望", "牽", "牵", "粘", "清", "淩", "凌", "渠", "淦", "淳", "淡", "梁", "寇", "宿", "扈", "逮", "逯", "尉", "屠", "張", "张", "隋", "將", "将", "陽", "阳", "隗", "隆", "習", "习", "貫", "贯", "終", "终", "紹", "绍", "巢", "貳", "贰", "琴", "琦", "堯", "尧", "塔", "項", "项", "越", "賁", "贲", "揚", "扬", "揭", "喜", "彭", "達", "达", "斯", "黃", "黄", "葉", "叶", "萬", "万", "葛", "董", "敬", "葷", "荤", "辜", "植", "森", "棟", "栋", "惠", "覃", "粟", "雲", "云", "斐", "紫", "掌", "戢", "開", "开", "閎", "闳", "閔", "闵", "遇", "景", "貴", "贵", "單", "单", "喻", "買", "买", "無", "无", "智", "嵇", "程", "稅", "税", "喬", "乔", "答", "傅", "集", "焦", "鄔", "邬", "須", "须", "舒", "鈔", "钞", "欽", "钦", "鈄", "钭", "鈕", "钮", "禽", "舜", "猶", "犹", "貿", "贸", "鄒", "邹", "馮", "冯", "童", "善", "普", "道", "曾", "勞", "劳", "湛", "湯", "汤", "滑", "游", "渾", "浑", "惲", "恽", "寒", "富", "運", "运", "祿", "禄", "尋", "寻", "强", "費", "费", "疏", "賀", "贺", "登", "瑞", "載", "载", "鄢", "勢", "势", "聖", "圣", "蓋", "盖", "鄞", "勤", "靳", "蒼", "苍", "蒯", "蓬", "蒿", "蒲", "蒙", "幹", "干", "楚", "楊", "杨", "裘", "甄", "賈", "贾", "雷", "零", "頓", "顿", "督", "訾", "虞", "業", "业", "睦", "睢", "愚", "路", "農", "农", "節", "节", "微", "徭", "愈", "愛", "爱", "貊", "詹", "解", "詩", "诗", "廉", "資", "资", "裔", "靖", "雍", "義", "义", "慈", "溥", "源", "溫", "温", "塗", "涂", "慎", "塞", "褚", "福", "辟", "經", "经", "碧", "趙", "赵", "嘉", "赫", "壽", "寿", "綦", "慕", "蔔", "卜", "蔡", "蔚", "蔣", "蒋", "厲", "厉", "碩", "硕", "爾", "尔", "臧", "裴", "暢", "畅", "聞", "闻", "閩", "闽", "閭", "闾", "鄲", "郸", "圖", "图", "種", "种", "稱", "称", "箕", "管", "毓", "僕", "仆", "僑", "侨", "僧", "僪", "銀", "银", "鳳", "凤", "說", "说", "廣", "广", "麽", "么", "廖", "竭", "韶", "端", "齊", "齐", "旗", "養", "养", "鄭", "郑", "榮", "荣", "漢", "汉", "滿", "满", "漆", "漫", "賓", "宾", "寧", "宁", "實", "实", "肇", "禚", "暨", "隨", "随", "翟", "翠", "熊", "鄧", "邓", "緒", "绪", "綫", "线", "撒", "駒", "驹", "鞏", "巩", "穀", "谷", "蕢", "蒉", "樓", "楼", "樊", "歐", "欧", "劇", "剧", "輝", "辉", "賞", "赏", "暴", "墨", "稽", "黎", "範", "范", "儀", "仪", "樂", "乐", "德", "衛", "卫", "盤", "盘", "銳", "锐", "劍", "剑", "虢", "餘", "余", "滕", "魯", "鲁", "劉", "刘", "諸", "诸", "諾", "诺", "談", "谈", "摩", "褒", "慶", "庆", "翦", "潜", "潮", "潭", "潘", "澄", "遲", "迟", "嬀", "妫", "練", "练", "緱", "缑", "駱", "骆", "操", "薑", "姜", "燕", "薛", "薊", "蓟", "薄", "蕭", "萧", "薩", "萨", "樹", "树", "樸", "朴", "橋", "桥", "機", "机", "賴", "赖", "融", "醜", "丑", "勵", "励", "曆", "历", "霍", "冀", "頻", "频", "盧", "卢", "閻", "阎", "蹉", "戰", "战", "穆", "篤", "笃", "興", "兴", "學", "学", "衡", "錯", "错", "錢", "钱", "鮑", "鲍", "獨", "独", "諶", "谌", "諫", "谏", "憑", "凭", "鄺", "邝", "磨", "龍", "龙", "嬴", "營", "营", "澹", "隱", "隐", "璩", "環", "环", "戴", "聲", "声", "鞠", "藍", "蓝", "藏", "韓", "韩", "檢", "检", "檀", "霜", "戲", "戏", "矯", "矫", "魏", "繁", "儲", "储", "禦", "御", "鍾", "锺", "斂", "敛", "鮮", "鲜", "謝", "谢", "糜", "應", "应", "齋", "斋", "濮", "濯", "賽", "赛", "蹇", "謇", "禮", "礼", "彌", "弥", "縱", "纵", "繆", "缪", "騎", "骑", "聶", "聂", "藤", "藩", "豐", "丰", "叢", "丛", "瞿", "闕", "阙", "曠", "旷", "顓", "颛", "簡", "简", "雙", "双", "邊", "边", "歸", "归", "鎮", "镇", "鎖", "锁", "謬", "谬", "顔", "颜", "額", "额", "禰", "祢", "藺", "蔺", "蘇", "苏", "麴", "闞", "阚", "關", "关", "蟻", "蚁", "嚴", "严", "羅", "罗", "鏡", "镜", "譚", "谭", "譙", "谯", "龐", "庞", "類", "类", "瀧", "泷", "懷", "怀", "繩", "绳", "壤", "蘭", "兰", "酆", "鹹", "咸", "黨", "党", "籍", "鐘", "钟", "釋", "释", "饒", "饶", "騰", "腾", "寶", "宝", "竇", "窦", "權", "权", "酈", "郦", "鐵", "铁", "鐸", "铎", "夔", "顧", "顾", "續", "续", "穰", "龔", "龚", "襲", "袭", "欒", "栾", "讓", "让", "蠻", "蛮", "釁", "衅", "鬱", "郁", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z",
];
...
// let name = 'Aycan and Zeynep and Berry and John and W.'
// console.log(name)

// name = new iname(name)
// console.log(name.apa_authors)


let bibtxt = `%(Brown & Zagefka,2011).
@article{2011The,
  ...
  pages={129-184},
  year={2011},
  note={http://ererererer%erere%rere}
}


%Valdes, J. M. (1986). 
@book{valdes1986culture,
...
@book{毕继万2009跨文化交际与第二语言教学,
  title={门与短信,山鸡,跨文化交际与第二语言教学},
  author={毕继万},
...
%(Ones & Viswesvaran,1997).
@article{1997Personality,
...
%(贺圣达,2010)
@article{贺圣达2010东亚文化圈和东亚价值观的历史考察——以中日韩,
...
%（Ward, C. , Bochner, S. , & Furnham, A. . ,2005).
@book{2005The,
...
%（Koveshnikov, A. , Wechtler, H. , & Dejoux, C,2014).
@article{2014Cross,
...
%(戴晓东,2011).
@article{戴晓东2011跨文化交际理论从欧洲中心到多中心演进探析,
...
%Koester, J., & Lustig, M. W. (1991)
@article{koester1991communication,
...
series = {Modernity and 'Asia' in the Study of Chinese History},
editor = {Eckhardt Fuchs, Benedikt Stuchtey}
pages ={322},
...
%(Tania, C. , Theorizing, G. , William, B. , & Oaks, C,2005). 
@article{2005Gallois,
...
%(Rathje & Stefanie,2007)
@article{Rathje2007Intercultural,
...
%(Benet-Martínez & Repke, 2020).
@article{benet2020broadening,
...
%（Aycan, Zeynep, Berry, John, & W. ,1996)
@article{Aycan1996Impact,
...
@article{wang2018job,
 ...
 %（Lau, D. C. , Lam, L. W. , & Wen, S. S. . ,2014)
 @article{2014Examining,
...
%Bakker, W., Van Der Zee, K., & Van Oudenhoven, J. P. (2006).
@article{bakker2006personality,
...
%Berry, J. W. (1997). Immigration, acculturation, and adaptation. Applied Psychology: At an International Review, 46(1), 5–34.
...
%Mak, A. S., Blewitt, K., & Heaven, P. C. (2004). 
@article{mak2004gender,
...
%Skinner, N., & Brewer, N. (2002). 
@article{skinner2002dynamics,
...
%Locher, J. L., Yoels, W. C., Maurer, D., & Van Ells, J. (2005).
@article{locher2005comfort,
...
%Froese, F. J., Peltokorpi, V., & Ko, K. A. (2012).
@article{froese2012influence,
...
%Peltokorpi, V. (2007).
@article{peltokorpi2007intercultural,
...
%Froese, F. J. (2010). 
@article{froese2010acculturation,
...
%Lueck, K., & Wilson, M. (2010).
@article{lueck2010acculturative,
...
%Eschbach, D. M., Parker, G. E., & Stoeberl, P. A. (2001).
@article{eschbach2001american,
...
%（Wilson, J., Ward, C., & Fischer, R. (2013)
@article{wilson2013beyond,
...
%Brandl, J., & Neyer, A. K. (2009).
@article{brandl2009applying,
...
%Cao, L., Hirschi, A., & Deller, J. (2014). 
@article{cao2014perceived,
...
%Parker, B., & McEvoy, G. M. (1993).
@article{parker1993initial,
...
%Segall, M. H., Dasen, P. R., Berry, J. W., & Poortinga, Y. H. (2000). 
@article{segall2000human,
...
%Hofstede, G., Hofstede, G. J., & Minkov, M. (2005).
...
@article{berry1989acculturation,
...
@book{enbocht,
    ...
    editor = {N. Eisenberg and J. Strayer}
    pages ={218-244},
...
%Kerem, E., Fishman, N., & Josselson, R. (2001).
@article{kerem2001experience,
...
%Dai, X., & Chen, G. M. (2015).
@article{dai2015interculturality,
...
@article{benet2006biculturalism,
...
%Verkuyten, M., & Martinovic, B. (2012).
@article{verkuyten2012immigrants,
...
%Nolan, E. M., & Morley, M. J. (2014).
@article{nolan2014test,
...
%Salo, C. D., & Birman, D. (2015).
@article{salo2015acculturation,
...
%Morris, M. A., & Robie, C. (2001).
@article{morris2001meta,
...
%Koo Moon, H., Kwon Choi, B., & Shik Jung, J. (2012). 
@article{koo2012previous,
...
%Takeuchi, R., Yun, S., & Tesluk, P. E. (2002)
@article{takeuchi2002examination,
  title={An examination of crossover and spillover effects of spousal and expatriate cross-cultural adjustment on expatriate outcomes.},
  author={Takeuchi, Riki and Yun, Seokhwa and Tesluk, Paul E},
  journal={Journal of applied psychology},
  volume={87},
...
%Selmer, J., & Lauring, J. (2015). 
@article{selmer2015host,
...
editor = {Dan Landis,Janet M.Bennett&Milton J.Bennett}
pages ={37-84},
...
%Copeland, A. P., & Norell, S. K. (2002).
@article{copeland2002spousal,
...
%Wang, X., & Kanungo, R. N. (2004). 
@article{wang2004nationality,
...
%Yavas, U., & Bodur, M. (1999).
@article{yavas1999correlates,
...
%Brailovskaia, J., Schönfeld, P., Kochetkov, Y., & Margraf, J. (2019). 
@article{brailovskaia2019does,
...
%Kraimer, M. L., Wayne, S. J., & Jaworski, R. A. A. (2001).
@article{kraimer2001sources,
...
%Takeuchi, R., Lepak, D. P., Marinova, S. V., & Yun, S. (2007).
@article{takeuchi2007nonlinear,
...
%Lee, R. M., Noh, C. Y., Yoo, H. C., & Doh, H. S. (2007). 
@article{lee2007psychology,
...
%Beiser, M. (2006).
@article{beiser2006longitudinal,
...
%Adams, B. G., & Van de Vijver, F. J. (2015).
@article{adams2015many,
...
%Ko, J., Frey, J. J., Osteen, P., & Ahn, H. (2015).
@article{ko2015moderating,
...
%Florkowski, G. W., & Fogel, D. S. (1999)
@article{florkowski1999expatriate,
...
%Mahajan, A., & Toh, S. M. (2014).
@article{mahajan2014facilitating,
...
%Hua, J., Fan, J., Walker, A., Hou, N., Zheng, L., & Debode, J. (2019）
@article{hua2019examinations,
...
%Black, J. S., & Stephens, G. K. (1989).
@article{black1989influence,
...
%Warner, S., & Wittner, J. G. (Eds.). (1998).
@book{warner1998gatherings,
...
%李茨婷. (2017). 
@article{李茨婷2017国际汉语教师跨文化教学能力研究述评简,
...
%Huberman, M. (1999).
@book{huberman1999understanding,
...
%Rojas Tejada, A. J., Cruz del Pino, R. M., Tatar, M., & Jiménez Sayáns, P. (2012).
@article{rojas2012spanish,
...
%刘涛, & 刘富华. (2013). 
@article{刘涛2013国际汉语教师课堂教学能力培训策略研究,
...
%Makarova, E., & Birman, D. (2020). 
@article{makarova2020teachers,
...
%Abayadeera, N., Mihret, D. G., & Hewa Dulige, J. (2018).
@article{abayadeera2018teaching,
...
@article{wang2015critical,
  ...
  pages={139--153},
  year={2015},
  publisher={CHIANG MAI UNIV, FAC SCIENCE 239 HUAY KAEW RD, T SUTHEP, CHIANG MAI, 50200~…}
}



%崔永华. (2020). 
@article{崔永华2020对外汉语教学的目标是培养汉语跨文化交际能力,
  title={对外汉语教学的目标是培养汉语跨文化交际能力},
  author={崔永华},
  journal={语言教学与研究},
  number={4},
  pages={12},
...
%张英. (2006).
@article{张英2006对外汉语文化因素与文化知识教学研究,
...
%张英. (2004).
@article{张英2004对外汉语文化教材研究——兼论对外汉语文化教学等级大纲建设,
...
%任仕超, & 梁文霞. (2014).
@article{任仕超2014中外远程协作课程对跨文化交际能力影响的实证研究,
...
%Burgess, J., & Rowsell, J. (2020).
@article{burgess2020transcultural,
...
%安然. (2013).
@inproceedings{安然2013孔子学院中方人员跨文化适应能力理论模式建构,
...
%刘彦伶. (2020). 
@phdthesis{刘彦伶2020赴韩汉语教师志愿者跨文化言语交际案例分析,
  title={赴韩汉语教师志愿者跨文化言语交际案例分析},
  author={刘彦伶},
  school={云南师范大学},
  year={2020},
}
...
%王一聪.2017
@phdthesis{王一聪0赴韩汉语志愿者教师跨文化交际个案研究,
...
%刘宁.2018
@phdthesis{刘宁0韩国全罗北道汉语教师志愿者调查研究,
...
%陈淼. (2019).
@phdthesis{陈淼2019赴韩汉语教师志愿者跨文化适应状况研究,
...
%郑梦真.2021
@phdthesis{郑梦真0跨文化交际视阈下韩国孔子学院汉语教师志愿者专业化发展研究,
  title={跨文化交际视阈下韩国孔子学院汉语教师志愿者专业化发展研究},
  author={郑梦真},
  school={吉林大学},
}
...
%曾捡飞. 2018
@phdthesis{曾捡飞0赴韩汉语教师志愿者跨文化适应研究,
...
孟小湉，2021
@phdthesis{孟小湉2021,
  title={韩国高中汉语教材教师用书研究——以《中国语1教师用书》为例},
  author={孟小湉},
  school={兰州交通大学},
  year=2021},
}
...
%张欣，2021
@phdthesis{张欣2021,
  title={韩国CPIK 独立教学项目汉语教师教学情况的考察与分析},
  author={张欣},
  school={福建师范大学},
  year={2021},
}
...
% 没找到：Taylor, C. (1992). Multiculturalism and the politics of recognition. Princeton, NJ: University of Princeton Press.



%Rudmin, F. W. (2003). 
@article{rudmin2003critical,
...
%Dona, G., & Berry, J. W. (1994). 
@article{dona1994acculturation,
...
%Pedraza, S. (2006).
@article{pedraza2006assimilation,
...
%Badea, C., Jetten, J., Iyer, A., & Er‐Rafiy, A. (2011). 
@article{badea2011negotiating,
...
%McClintock, C. G., & Davis, J. (1958).
@article{mcclintock1958changes,
...
%Martinovic, B., & Verkuyten, M. (2012). 
@article{martinovic2012host,
...
%任远. (1995).
@article{任远1995新一代基础汉语教材编写理论与编写实践,
...
%李泉, & 宫雪. (2015). 
@article{李泉2015通用型、区域型、语别型、国别型——谈国际汉语教材的多元化,
...
%潘雪扬. (2017).
@article{潘雪扬2017对外汉语教师在厄瓜多尔的跨文化适应,
...
%吕俞辉, & 汝淑媛. (2012). 
@article{吕俞辉2012对外汉语教师海外工作跨文化适应研究,
...
%陆茵茵. (2018). 
@article{陆茵茵2018赴新西兰汉语教师志愿者跨文化适应研究,
...
%许依莹，2019
@phdthesis{许依莹0对外汉语教师入职期跨文化适应研究,
...
%陈向明. (2015). 
@article{陈向明2015扎根理论在中国教育研究中的运用探索,
...
%Schulz, R. A., & Ganz, A. (2010).
@article{schulz2010developing,
...
沒找到：Sohn, H.M. Korean Language In Culture Furthermore, Society; KLEAR textbooks in Korean Language; University of Hawaii Press:
Honolulu, HI, USA, 2005.
...
%Schneider, D. M., & Schneider, D. M. (1980). 
@book{schneider1980american,
...
%李曉紅, & 王瑞芳. (2019). 教學理念對教師教學行為的影響研究. 教育教學論壇, (22), 68-69.
@article{李曉紅, & 王瑞芳2019教學理念對教師教學行為的影響研究,
...
%Richardson, V. (2003). 
@article{richardson2003constructivist,
...
%张辉女. (2002). 
@article{张辉女2002汉字和汉语与朝鲜半岛语言的关系,
...
%Alujevi´c, M.; Braovi´c Plavša, M. The effect of psychotypology and linguistic attitudes towards target language on the occurrence of transfer on the receptive level upon the first contact of croatian speakers with italian as L2. Folia Linguist. Litt. 2021, XII, 249–270.
[CrossRef]
@article{Alujevi´c, M.; Braovi´c Plavša, M.2021,
...
% Qìzhong, S. The structure of Chinese characters in Modern Mandarin. Korean Lang. 1992, 1, 1–85.
@article{ Qìzhong, S. The structure of Chinese characters in Modern Mandarin,
  title={The structure of Chinese characters in Modern Mandarin},
  author={Qìzhong, S},
  journal={Korean Lang},
  year={1992}
}
...
%魏慧萍. 当代语境下的汉韩共有汉字词汇研究[J]. 中国学论丛,2013.
@article{魏慧萍2013当代语境下的汉韩共有汉字词汇研究,
...
% 没找到：李宇明. (Ed.) (2016) 全球华语大词典. 商务印刷馆.



%郑定欧. (2004).
@article{郑定欧2004论面向对外汉语教学的基础研究,
...
%McCarthy, P. R., & McCarthy, H. M. (2006).
@article{mccarthy2006case,
...
%Schacter, Daniel2011
@book{Schacter, Daniel2011Psychology,
  title={Psychology},
  author={Schacter, Daniel},
  year={2011},
...
%Gao, G., & Ting-Toomey, S. (1998). 
@book{gao1998communicating,
...
% 端午祭：https://www.ihchina.cn/Article/Index/detail?id=11700
...
%Hackett, C., Grim, B. J., Stonawski, M., Skirbekk, V., Potančoková, M., & Connor, P. (2012).
@misc{hackett2012global,
  title={The global religious landscape. Pew Research Center},
  author={Hackett, C and Grim, BJ and Stonawski, M and Skirbekk, V and Potan{\v{c}}okov{\'a}, M and Connor, P},
  year={2012}
}
...
%Weightman, G., & Humphries, S. (1988). 
@book{weightman1988christmas,
...
%Berry, J. W., & Sabatier, C. (2011).
@article{berry2011variations,
...
%Mol, S. T., Born, M. P., Willemsen, M. E., & Van Der Molen, H. T. (2005). 
@article{mol2005predicting,
...
%Kappe, R., & van der Flier, H. (2010). 
@article{kappe2010using,
...
%Allen, J. D., Caspi, C., Yang, M., Leyva, B., Stoddard, A. M., Tamers, S., ... & Sorensen, G. C. (2014). 
@article{allen2014pathways,
...
%Rehm, J., Gmel Sr, G. E., Gmel, G., Hasan, O. S., Imtiaz, S., Popova, S., ... & Shuper, P. A. (2017). 
...
%Shield, K. D., Parry, C., & Rehm, J. (2014). 
@article{shield2014chronic,
...
%Verbeke, W., & Poquiviqui Lopez, G. (2005). 
@article{verbeke2005ethnic,
...
%Cárdenas, D., De la Sablonnière, R., Gorborukova, G. L., Mageau, G. A., Amiot, C. E., & Sadykova, N. (2019).
@article{cardenas2019participation,
...
%Min, W., Jin, D. Y., & Han, B. (2019). 
@article{min2019transcultural,
...
%Paolillo, R., & Jager, W. (2020). 
@article{paolillo2020simulating,
...
%Hou, F., Schellenberg, G., & Berry, J. (2018). 
@article{hou2018patterns,
...
%Chae, M. H., & Foley, P. F. (2010). 
@article{chae2010relationship,
...
title= {Empathy
and Its Development },
series = {Affective and Cognitive Perspectives on
Empathy},
editor = {N. Eisenberg & J. Strayer}
pages ={218-244},
...
%Thoma, M. V., Ryf, S., Mohiyeddini, C., Ehlert, U., & Nater, U. M. (2012). 
...
%Falk, J. H., Ballantyne, R., Packer, J., & Benckendorff, P. (2012).
@article{falk2012travel,
...
%Salton, G., & Yu, C. T. (1973). 
@article{salton1973construction,
...
Rajaraman, A.; Ullman, J.D. Data Mining. In Mining of Massive Datasets; Rajaraman, A., Ullman, J.D., Eds.; Cambridge University
Press: Cambridge, UK, 2011; pp. 1–17.
...
%Gudykunst, W. B. (2005).
@book{gudykunst2005anxiety,
  title={An Anxiety/Uncertainty Management (AUM) Theory of Strangers' Intercultural Adjustment.},
...
@article{chen1996intercultural,
  title={Intercultural communication competence: A synthesis},
  author={Chen, Guo-Ming and Starosta, William J},
...
%Arasaratnam, L. A., & Doerfel, M. L. (2005). 
@article{arasaratnam2005intercultural,
  title={Intercultural communication competence: Identifying key components from multicultural perspectives},
  author={Arasaratnam, Lily A and Doerfel, Marya L},
  journal={International journal of intercultural relations},
  volume={29},
  number={2},
  pages={137--163},
...
%Imahori, T. T., & Lanigan, M. L. (1989). 
@article{imahori1989relational,
  title={Relational model of intercultural communication competence},
  author={Imahori, T Todd and Lanigan, Mary L},
  journal={International Journal of Intercultural Relations},
  volume={13},
  number={3},
  pages={269--286},
...
%Strauss, A., Corbin, J., & 徐宗国. (1997).
@article{strauss1997质性研究概论,
  title={质性研究概论},
  author={Strauss, Anselm and Corbin, Juliet and 徐宗国},
  journal={台北: 巨流图书公司},
  volume={135},
  year={1997}
}
...
%翟海源, 毕恒达, & 刘长萱. (2013). 
@misc{翟海源2013社会及行为科学研究,
  title={社会及行为科学研究 (二): 质性研究方法},
  author={翟海源 and 毕恒达 and 刘长萱},
  year={2013},
...
%Hammersley, M. (2013).
@book{hammersley2013s,
  title={What's wrong with ethnography?},
...
%Xu, K., Drennan, J., & Mathews, S. (2019).
@article{xu2019immigrant,
  title={Immigrant entrepreneurs and their cross-cultural capabilities: A study of Chinese immigrant entrepreneurs in Australia},
  author={Xu, Kunlin and Drennan, Judy and Mathews, Shane},
...
filename = "bbl.txt";
fs.writeFile(filename, bbl, function (err) {
    if (err) throw err;
    console.log('File saved!');
});